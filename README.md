      ...
      * {
      ...
      body {
        ...
        background: radial-gradient(
            circle at 15% 10%,
            rgba(69, 230, 255, 0.14),
            transparent 20%
          ),
          radial-gradient(
            circle at 85% 15%,
            rgba(255, 93, 177, 0.16),
            transparent 20%
          ),
          radial-gradient(
            circle at 50% 100%,
      ...
      .grid-bg {
        ...
        background-image: linear-gradient(
            rgba(69, 230, 255, 0.08) 1px,
            transparent 1px
          ),
          linear-gradient(90deg, rgba(69, 230, 255, 0.08) 1px, transparent 1px);
      ...
      .xp-fill {
        ...
        box-shadow: 0 0 20px rgba(69, 230, 255, 0.25);
        position: relative;
      }
      ...
      .primary {
        ...
        box-shadow: 0 10px 30px rgba(255, 93, 177, 0.2);
      }
      ...
      .lane {
        ...
        border-radius: 24px;
        overflow: hidden;
        border: 2px solid rgba(69, 230, 255, 0.18);
        background: linear-gradient(
            to top,
            rgba(8, 16, 31, 0.96),
            rgba(8, 16, 31, 0.35) 24%,
            transparent 24%
          ),
          linear-gradient(
            to right,
      ...
      .pin {
        ...
        transition: transform 0.55s ease, opacity 0.45s ease, filter 0.3s ease;
      }
      ...
      .pin.hidden {
        opacity: 0;
        transform: translateY(18px) rotate(38deg) scale(0.82);
        filter: blur(1px);
      }
      ...
      .aim {
        ...
        background: linear-gradient(
          180deg,
          rgba(69, 230, 255, 0.15),
          rgba(69, 230, 255, 0.95),
          rgba(69, 230, 255, 0)
        );
        transform-origin: bottom center;
        pointer-events: none;
        z-index: 2;
        box-shadow: 0 0 12px rgba(69, 230, 255, 0.4);
      }
      ...
      @keyframes roll {
        ...
        100% {
          transform: translateX(calc(-50% + var(--drift)))
            translateY(calc(-1 * var(--distance))) scale(0.48) rotate(720deg);
        }
      }
      ...
      .ball-option.active {
        ...
        box-shadow: 0 0 0 1px rgba(255, 216, 77, 0.28) inset;
      ...
      .mini-ball.flame {
        ...
        box-shadow: 0 0 12px rgba(255, 110, 30, 0.28);
      }
      ...
      .mini-ball.sparkly {
        ...
        box-shadow: 0 0 12px rgba(255, 93, 177, 0.25);
      }
      ...
      .mini-ball.blue {
        ...
        box-shadow: 0 0 12px rgba(69, 230, 255, 0.25);
      }
      ...
      .mini-ball.birthday {
        ...
        box-shadow: 0 0 12px rgba(255, 216, 77, 0.22);
      }
    ...
    <div class="wrap">
      <section class="hero">
        ...
        <div class="hero-grid">
          <div>
            <h1>
              Brad is <span class="gradient">Leveling Up</span><br />to 30 🎳
            </h1>
            <p class="sub">
              Join us for birthday bowling in honor of Brad hitting Level 30!
              Expect bowling, food, drinks, and a good time. Warm up for the
              party by taking a shot in the mini game below.
            </p>
          </div>
          ...
          <div class="card">
            ...
            <div class="quest-list">
              ...
              <div class="quest">
                ...
                <div class="value">
                  Railroad + Strikerz at Angel of the Winds Casino
                </div>
              </div>
              <div class="quest">
                <div class="label">Objective</div>
                <div class="value">
                  Bowl a few frames, eat good food, and celebrate Brad.
                </div>
              </div>
              <div class="quest">
            ...
            <p class="note">
              We’ll be eating an early dinner at Railroad at 3:00 PM before
              bowling at 5:00 PM. We’d love for you to join us for dinner too.
              Bowling is $10/person. If you want to bowl, you can Venmo Brad at
              <strong>@Bradley-Jarvensivu</strong>.
            </p>
              ...
              <div class="control-panel">
                ...
                <div class="game-main">
                  <div class="lane-wrap">
                    <div class="lane" id="lane">
                      <div class="lane-overlay-top">
                        ...
                        <div class="lane-badge" id="frameSummary">
                          Frame 1 · Roll 1
                        </div>
                      </div>
                      ...
                      <div class="lane-hint">
                        Drag ball or tap lane to move • then roll
                      </div>
                  ...
                  <div class="subcard controls-block">
                    ...
                    <div class="cta-row">
                      <button class="primary" id="rollBtn" type="button">
                        Send It
                      </button>
                    ...
                    <div class="tiny" style="margin-top: 8px">
                      Keyboard: ← → move ball · A / D aim · ↑ ↓ power · J / L
                      spin · Space roll
                    </div>

                    <div class="result" id="result" style="margin-top: 10px">
                      Can you earn birthday bragging rights?
                    </div>
                  </div>
                </div>
              </div>
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        ...
        const ballOptions = Array.from(
          document.querySelectorAll(".ball-option")
        );

        const scoreCells = {
          1: {
            r1: document.getElementById("f1r1"),
            r2: document.getElementById("f1r2"),
            t: document.getElementById("f1t"),
          },
          2: {
            r1: document.getElementById("f2r1"),
            r2: document.getElementById("f2r2"),
            t: document.getElementById("f2t"),
          },
          3: {
            r1: document.getElementById("f3r1"),
            r2: document.getElementById("f3r2"),
            t: document.getElementById("f3t"),
          },
        };
        ...
        let highScore = Number(
          localStorage.getItem("bradLevel30BowlingHighScoreV4") || 0
        );
        ...
        function setBallStyle(style) {
          ...
          if (style === "sparkly") {
            ball.innerHTML =
              '<div class="spark-stars"></div><div class="finger"></div>';
          } else if (style === "flame") {
            ball.innerHTML =
              '<div class="flame-lines"></div><div class="finger"></div>';
          } else if (style === "blue") {
            ball.innerHTML =
              '<div class="aura-rings"></div><div class="finger"></div>';
          } else if (style === "red") {
            ball.innerHTML =
              '<div class="aura-rings"></div><div class="finger"></div>';
          } else if (style === "birthday") {
            ball.innerHTML =
              '<div class="sprinkles"></div><div class="finger"></div>';
          }
        ...
        function ballStyleBonus() {
          switch (selectedBall) {
            case "flame":
              return { power: 0.45, strike: 0.03, spin: -0.02 };
            case "sparkly":
              return { power: 0.15, strike: 0.04, spin: 0.03 };
            case "blue":
              return { power: 0.1, strike: 0.05, spin: 0.08 };
            case "red":
              return { power: 0.2, strike: 0.04, spin: 0.02 };
            case "birthday":
              return { power: 0.25, strike: 0.08, spin: 0.01 };
            default:
              return { power: 0, strike: 0, spin: 0 };
          }
        }
        ...
        function scoreRoll(angle, power, spin, remainingPins) {
          ...
          const accuracyPenalty =
            Math.abs(angle + effectiveSpin * 0.35) * 0.22 + startOffsetPenalty;
          ...
          let score = Math.round(
            4 + powerBonus + spinBonus - accuracyPenalty + randomness
          );

          const strikeChance = 0.4 + bonus.strike;
          if (
            Math.abs(angle) <= 4 &&
            power >= 74 &&
            Math.abs(effectiveSpin) <= 12 &&
            Math.abs(ballX - 50) <= 8 &&
            Math.random() > 1 - strikeChance
          ) {
        ...
        function writeRollToScoreboard(
          knocked,
          isStrike = false,
          isSpare = false
        ) {
          ...
          frameScores[frame].total =
            (typeof frameScores[frame].r1 === "number"
              ? frameScores[frame].r1
              : frameScores[frame].r1 === "X"
              ? 10
              : 0) +
            (typeof frameScores[frame].r2 === "number"
              ? frameScores[frame].r2
              : frameScores[frame].r2 === "/"
              ? 10 -
                (typeof frameScores[frame].r1 === "number"
                  ? frameScores[frame].r1
...
If you want to bowl, Venmo Brad @Bradley-Jarvensivu`;
          ...
          try {
            ...
            copyStatus.textContent =
              "Invite text copied — just swap in your real link.";
          } catch (err) {
            copyStatus.textContent =
              "Clipboard access was blocked here, but the invite text is built into the code.";
          }
        }
        ...
        document.addEventListener("keydown", (e) => {
          ...
          if (e.key.toLowerCase() === "j")
            adjustSlider(spinSlider, -2, -30, 30);
